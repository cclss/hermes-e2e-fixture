...
// g9 최종 밸런스: 박진감을 위해 핸들링을 약간 더 날카롭게(DAS 120→110,
// ARR 22→16, 소프트드롭 28→24). 여전히 손가락이 따라갈 수 있는 범위.
const DAS_MS = 110; // 자동 횡이동 시작 지연
const ARR_MS = 16; // 자동 횡이동 반복 간격
const SOFT_DROP_MS = 24; // 소프트드롭 반복 간격
